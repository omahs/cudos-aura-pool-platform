...
export default class AddNftsToCollectionStepState {
    repoStore: RepoStore;
    ...
    constructor(collectionEntity: CollectionEntity, repoStore: RepoStore, accountSessionStore: AccountSessionStore) {
